    ...
    return (
        <>
            <Navbar collapseOnSelect expand="lg" variant="light" sticky='top'>
                <Container>
                    <Navbar.Brand id="nav-link" as={HashLink} className="text-dark p-2" to="/home">Anik</Navbar.Brand>
                    ...
                    <Navbar.Brand id="nav-link" as={HashLink} className="text-dark p-2" to="/home">Dhar</Navbar.Brand>
